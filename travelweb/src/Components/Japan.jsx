...
const japan = () => {
  return (
    ...
    <Styleim>
  <center> 
  <img src="https://www.exotravel.com/assets/content/destinations/images/flag-japan.png" />
   </center>
    </Styleim>
  ...
  <hr style={{
    ...
    <Styleparao>
    <p>Japan lends itself well to epics. Snaking sinuously down from the Chinese border to the Gulf of Thailand, its bounty of towering peaks, emerald green paddies, seemingly endless white sand beaches and deep roots in the past offer enough mystic allure to satiate the thirsts of any traveller.</p>
    </Styleparao>
    <Stylebutt>
<center><Button variant="contained" sx={{boxShadow:4 , backgroundColor:'#097dd5' , color:'white' , fontWeight:'bolder'}}>Watch Video</Button></center>
    ...
    <Card sx={{ borderRadius: '20px ', maxWidth: 345, marginTop: '40px', boxShadow: 4 }}>
      <CardActionArea>
        <CardMedia  style={{ width: '450px' }}
          ...
          image="https://images.unsplash.com/photo-1526374073174-7661a8028eb4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTd8fGphcGFufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
          alt="green iguana"
        />
        <CardContent>
    ...
    <Card sx={{ borderRadius: '20px ', maxWidth: 345, marginTop: '40px', boxShadow: 4 }}>
      <CardActionArea>
        <CardMedia style={{ width: '450px' }}
          ...
          image="https://images.unsplash.com/photo-1558869632-279458ac1734?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTgwfHxqYXBhbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
          alt="green iguana"
        />
        <CardContent>
          <Typography gutterBottom variant="h5" style={{ color: 'gray', fontWeight: 'bolder' }} component="div">
  ...
  <Stylepar>
   ...
   <Styleimgs>
     <img src="https://images.unsplash.com/photo-1566204978576-77f6addcef4d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTA0fHxqYXBhbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"/>

     <img src="https://images.unsplash.com/photo-1606829259757-a0d1f110d4a3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDI2fHxqYXBhbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"/>

     <img src="https://images.unsplash.com/photo-1450740199001-78e928502994?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDg1fHxqYXBhbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"/>
   </Styleimgs>
   <Styleop>
   <center><Button variant="contained" sx={{boxShadow:4 , backgroundColor:'#097dd5' , color:'white' , fontWeight:'bolder'}}>View More</Button></center>
   </Styleop>
