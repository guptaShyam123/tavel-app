...
<center><Button variant="contained" sx={{boxShadow:4 , backgroundColor:'#097dd5' , color:'white' , fontWeight:'bolder'}}>Watch Video</Button></center>
    ...
    <Card sx={{ borderRadius: '20px ', maxWidth: 345, marginTop: '40px', boxShadow: 4 }}>
      <CardActionArea>
        <CardMedia  style={{ width: '450px' }}
          ...
          image="https://images.unsplash.com/photo-1620549146396-9024d914cd99?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzB8fGluZG9uZXNpYXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
          alt="green iguana"
        />
        <CardContent>
    ...
    <Card sx={{ borderRadius: '20px ', maxWidth: 345, marginTop: '40px', boxShadow: 4 }}>
      <CardActionArea>
        <CardMedia style={{ width: '450px' }}
          ...
          image="https://images.unsplash.com/photo-1592364395653-83e648b20cc2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Njh8fGluZG9uZXNpYXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
          alt="green iguana"
        />
        <CardContent>
          <Typography gutterBottom variant="h5" style={{ color: 'gray', fontWeight: 'bolder' }} component="div">
  ...
  <Stylepar>
   ...
   <Styleimgs>
     <img src="https://images.unsplash.com/photo-1605797154113-66658362d382?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTk5fHxpbmRvbmVzaWF8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"/>

     <img src="https://images.unsplash.com/photo-1520333764090-778d6dc95ec3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzIxfHxpbmRvbmVzaWF8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"/>

     <img src="https://images.unsplash.com/photo-1531662439848-a7ed93c51468?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzQ0fHxpbmRvbmVzaWF8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"/>
   </Styleimgs>
   <Styleop>
   <center><Button variant="contained" sx={{boxShadow:4 , backgroundColor:'#097dd5' , color:'white' , fontWeight:'bolder'}}>View More</Button></center>
   </Styleop>
