    ...
    <Card sx={{ borderRadius: '20px ', maxWidth: 345, marginTop: '40px', boxShadow: 4 }}>
      <CardActionArea>
        <CardMedia  style={{ width: '450px' }}
          ...
          image="https://thumbs.dreamstime.com/b/one-pilar-pagoda-hanoi-vietnam-turtle-tower-sword-lake-spring-65126200.jpg"
          alt="green iguana"
        />
        <CardContent>
    ...
    <Card sx={{ borderRadius: '20px ', maxWidth: 345, marginTop: '40px', boxShadow: 4 }}>
      <CardActionArea>
        <CardMedia style={{ width: '450px' }}
          ...
          image="https://thumbs.dreamstime.com/b/fishing-boats-village-koh-rong-cambodia-island-main-beach-tropical-holiday-traditional-wooden-49792170.jpg"
          alt="green iguana"
        />
        <CardContent>
          <Typography gutterBottom variant="h5" style={{ color: 'gray', fontWeight: 'bolder' }} component="div">
