...
<center><Button variant="contained" sx={{boxShadow:4 , backgroundColor:'#097dd5' , color:'white' , fontWeight:'bolder'}}>Watch Video</Button></center>
    ...
    <Card sx={{ borderRadius: '20px ', maxWidth: 345, marginTop: '40px', boxShadow: 4 }}>
      <CardActionArea>
        <CardMedia  style={{ width: '450px' }}
          ...
          image="https://thumbs.dreamstime.com/b/thailand-farm-rice-evening-58814468.jpg"
          alt="green iguana"
        />
        <CardContent>
    ...
    <Card sx={{ borderRadius: '20px ', maxWidth: 345, marginTop: '40px', boxShadow: 4 }}>
      <CardActionArea>
        <CardMedia style={{ width: '450px' }}
          ...
          image="https://thumbs.dreamstime.com/b/chiang-mai-thailand-illuminated-temples-phra-singh-sunset-golden-walls-blue-sky-85400848.jpg"
          alt="green iguana"
        />
        <CardContent>
          <Typography gutterBottom variant="h5" style={{ color: 'gray', fontWeight: 'bolder' }} component="div">
    ...
    <Card sx={{ borderRadius: '20px ', maxWidth: 345, marginTop: '40px', boxShadow: 4 }}>
      <CardActionArea>
        <CardMedia style={{ width: '450px' }}
          ...
          image="https://thumbs.dreamstime.com/b/bangkok-thailand-temple-emerald-buddha-grand-palace-bangkok-thailand-temple-emerald-buddha-146390838.jpg"
          alt="green iguana"
        />
        <CardContent>
          <Typography gutterBottom variant="h5" style={{ color: 'gray', fontWeight: 'bolder' }} component="div">
  ...
  <Stylepar>
   ...
   <Styleimgs>
     <img src="https://thumbs.dreamstime.com/b/winding-country-road-west-virginia-winding-road-countryside-appalachian-mounntain-area-west-virginia-238825389.jpg"/>

     <img src="https://thumbs.dreamstime.com/b/india-tourist-attraction-mughal-architecture-gwalior-fort-gwalior-madhya-pradesh-india-gwalior-fort-111857015.jpg"/>
